...
rule get_variant_precision_score_distance_csv:
    input:
         ...
         variants_calls = lambda wildcards: f"{precision_reports}/{wildcards.truth_id}/all/snippy_{wildcards.ref_id}/coverage_filter_Not_App/strand_bias_filter_Not_App/gaps_filter_Not_App/variant_calls_probeset_report.tsv"
    output:
